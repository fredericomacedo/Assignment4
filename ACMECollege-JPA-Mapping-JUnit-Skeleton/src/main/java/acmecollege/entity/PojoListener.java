...
public class PojoListener {
	...
	public void setCreatedOnDate(PojoBase pojoBase) {
		...
		pojoBase.setCreated(now); // PL02 - We wish to alter 'created' field just before object is INSERT'd in the database.
		pojoBase.setUpdated(now); // We should also set 'updated' field at this time as well.
	}
	...
	public void setUpdatedDate(PojoBase pojoBase) {
		...
		pojoBase.setUpdated(LocalDateTime.now()); // PL04 - We wish to alter 'updated' field just before object is UPDATE'd in the database.
	}
